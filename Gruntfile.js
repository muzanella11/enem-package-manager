...
//		console.log('enem'),
		...
		sass: {
			...
			dist: {
				...
				files: {
					'css/enem.min.css': 'enem_apps/master_enem/master_enem.scss',
				}
			},
			dev: {
				options: {
				...
				files: {
					'css/enem.css': 'enem_apps/master_enem/master_enem.scss',
				}
			}
		},
...
//	            }]
				files: {
					'css/enem.min.css': ['css/enem.min.css']
				}
			}
		},
...
//					'bower_components/tinymce/tinymce.js',
                    ...
                    //Enem Required Plugin Fullpage js
//                    'bower_components/fullpage.js/jquery.fullPage.js',
                    
                    //Enem Required Plugin Scrollify js
